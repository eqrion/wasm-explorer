...
#[doc(hidden)]
#[allow(non_snake_case)]
pub unsafe fn __post_return_print_decompiled<T: Guest>(arg0: *mut u8) {
    let l0 = i32::from(*arg0.add(0).cast::<u8>());
    match l0 {
        0 => {
            let l1 = *arg0.add(::core::mem::size_of::<*const u8>()).cast::<*mut u8>();
...
macro_rules! __export_world_wasm_tools_cabi {
    ($ty:ident with_types_in $($path_to_types:tt)*) => {
        ...
        $($path_to_types)*:: _export_parse_cabi::<$ty > (arg0, arg1) } } #[unsafe
        (export_name = "cabi_post_parse")] unsafe extern "C" fn _post_return_parse(arg0 :
        * mut u8,) { unsafe { $($path_to_types)*:: __post_return_parse::<$ty > (arg0) } }
        #[unsafe (export_name = "print")] unsafe extern "C" fn export_print(arg0 : * mut
        u8, arg1 : usize, arg2 : i32,) -> * mut u8 { unsafe { $($path_to_types)*::
        _export_print_cabi::<$ty > (arg0, arg1, arg2) } } #[unsafe (export_name =
...
macro_rules! __export_wasm_tools_impl {
    ...
    ($ty:ident with_types_in $($path_to_types_root:tt)*) => {
        $($path_to_types_root)*:: __export_world_wasm_tools_cabi!($ty with_types_in
        $($path_to_types_root)*);
    };
}
#[doc(inline)]
...
A\x0d\x01q\x07\x03str\x01s\0\x04name\0\0\x07literal\0\0\x07keyword\0\0\x04type\0\
...
@\x02\x08contents\x02\x08skeleton\x7f\0\x06\x04\0\x05print\x01\x07\x01j\x01s\x01\
s\x01@\x01\x08contents\x02\0\x08\x04\0\x10print-decompiled\x01\x09\x04\0\x1ecomp\
onent:component/wasm-tools\x04\0\x0b\x10\x01\0\x0awasm-tools\x03\0\0\0G\x09produ\
