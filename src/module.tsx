...
import { LoadedMessageId, type ModuleId, type MessageId, FirstMessageId, type MessageToWorker, MessageFromWorkerKind, type MessageFromWorker, MessageToWorkerKind } from "./messages.js"

let nextMessageId: MessageId = FirstMessageId;

async function sendMessage(message: MessageToWorker): Promise<MessageFromWorker> {
...
let registry = new FinalizationRegistry(async (moduleId: ModuleId) => {
    await sendMessage({kind: MessageToWorkerKind.Destroy, id: nextMessageId++, moduleId});
});
